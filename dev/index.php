...
<div class="container-fluid text-center alignSubMenu">
    <section>
        <article>
            <ul class="inline list-inline">
                <li class="list-inline-item"><h3 class="bigFont mr-3" style="text-decoration: underline;"><a href="#">Sneakers</a></h3></li>
                <li class="list-inline-item"><h3 class="bigFont ml-3"><a href="#">Streetwear</a></h3></li>
            </ul>
